...
<%@include file="all_component/navbar.jsp"%>
  ...
  <div class="container fluid">
		<div class="row ">
			<div class="col-md-12 ">
				<h5 class="text-center text-primary"> All Student Profile Request &nbsp;&nbsp;<i class="fa-solid fa-users"></i></h5>
           ...
           <br>
			<%
				...
				List<User> list = dao.getAllUserReqlist();
				for (User j : list) {
			%>
				<div class="card mt-1 main1">
					<div class="card-body"><h6>
							For: Edit / Correction&nbsp;<i class="fa-solid fa-pen-to-square"></i></h6>
