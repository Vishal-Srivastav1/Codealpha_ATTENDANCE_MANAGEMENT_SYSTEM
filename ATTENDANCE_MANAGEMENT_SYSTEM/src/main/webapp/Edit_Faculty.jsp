          ...
          <div class="row g-3 ">
             <div class="col-md-6 offset-md-3">
                 <div class="card main">
					...
					Faculty j=dao.getFacultyById(id);
			          	%>
							
					<form action="edit_faculty" method="post">
						 
						<input type="hidden" value="<%=j.getId() %>" name="id">
							<div class="form-group">
								<label for="title1" class="form-label">Enter Faculty Name</label> <input
									type="text" name="name" class="form-control" value="<%=j.getName()%>" id="title1"
							...
							<div class="form-group">
								...
								<textarea class="form-control"  name="description" id="Frmgrp" rows="3"
									cols="" required placeholder="Enter Description here "><%=j.getDescription()%></textarea>
							</div>
							<br>

							<button class="btn btn-primary w-50 ">Update Faculty</button>					   
						</form>
